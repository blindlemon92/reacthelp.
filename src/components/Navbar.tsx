  ...
  return (
    <nav className='flex items-center justify-between flex-wrap bg-teal-500 p-6'>
        ...
        <div className="block">
            <button 
                onClick={dropDown}
                className="flex item-center px-3 py-2 text-teal-200 border rounded 
                border-teal-400 hover:text-white hover:border-white">
                    <i className="fa-sharp fa-regular fa-ufo-beam"></i>
            </button>
        </div>
        { isVisible ? (
            ...
            <div className="text-sm lg: flex-grow">
                <Button className="p-3 m-5 bg-teal-400 justify-center">
                    <div>
                        ...
                        text-teal-200 hover:text-white mr-4">Home
                        </Link>
                    </div>
                </Button>
                <Button className="p-3 m-5 bg-teal-400 justify-center">
                    <div>
                        ...
                        text-teal-200 hover:text-white mr-4">About
                        </Link>
                    </div>
                </Button>
                <Button className="p-3 m-5 bg-teal-400 justify-center">
                    <div>
                        ...
                        text-teal-200 hover:text-white mr-4">Dashboard
                        </Link>
                    </div>
                </Button>
            </div>
